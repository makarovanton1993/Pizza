...
import { addItem, removeItem, minusItem, selectCart,plusItem } from '../redux/slices/CartSlice';

export type CartItemPros = {
  id:string,
  imageUrl:string,
  totalPrice:number
  count:number,
...
const CartItem:React.FC<CartItemPros> = function({
  id,
  imageUrl,
  count,
  name,
